...
def mark_all_ingested(limit: int = 0) -> int:
    """Mark the top `limit` pending articles (by the same priority order run_prepare/ingest
    used to build pending_ingest.md) as ingested, after Claude processed them."""
    from prioritize import prioritize
